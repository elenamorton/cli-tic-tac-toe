...
describe 'Game' do
  ...
  describe '#score' do
    ...
    it 'calculates score for an empty board' do
      expect(game.calculate_score(3, Game::X_MARKER)).to eq ({:D=>0, :antiD=>0, :R0=>0, :R1=>1, :R2=>0, :C0=>1, :C1=>0, :C2=>0})
    ...
    it 'calculates score for "O" wins and "X" loses game ' do
      ...
      expect(game.calculate_score(6, Game::O_MARKER)).to eq ({:D=>-1, :antiD=>-3, :R0=>0, :R1=>0, :R2=>-1, :C0=>0, :C1=>0, :C2=>-1})
    ...
    it 'calculates score for a tie game' do
      ...
      game.calculate_score(5, Game::X_MARKER)
      expect(game.calculate_score(8, Game::O_MARKER)).to eq ({:D=>1, :antiD=>1, :R0=>-1, :R1=>1, :R2=>-1, :C0=>1, :C1=>-1, :C2=>-1})
    end
